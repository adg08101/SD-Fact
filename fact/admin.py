...
from .models import Sprint, Task, TaskType, TaskCreator, PRType, PR, Responsable, PointingEnvironments
...
class PRAdmin(admin.ModelAdmin):
    ordering = ['pr_number']
    search_fields = ['pr_number', 'task__task_number']
...
admin.site.register(PointingEnvironments)
